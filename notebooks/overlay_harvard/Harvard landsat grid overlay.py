...
base_dname = r"J:\Projects\NCCSC\phenocam\DerivedData\harvard"
...
Image(filename=os.path.join(base_dname, "ArcScene", "ScreenGrab.png"))
...
phenosite = pyphenocam.dataaccess.get_site('harvard')
which_img = -197
...
plt.imshow(landsat_data[0,:,:], interpolation='none', vmin=0, vmax=1)
pyphenocam.plotting.format_photo_axes(plt.gca())
plt.scatter(*(x, y))
